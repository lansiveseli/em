...
<head>
   ...
   <title>llogaritë e përdoruesve</title>
...
<section class="accounts">
   ...
   <h1 class="heading">llogaritë e përdoruesve</h1>
   ...
   <div class="box">
      ...
      <p> emaili: <span><?= $fetch_accounts['email']; ?></span> </p>
      <a href="users_accounts.php?delete=<?= $fetch_accounts['id']; ?>" onclick="return confirm('delete this account?')" class="delete-btn">Fshije</a>
   </div>
   <?php
         }
      }else{
